...
namespace TrickingLibrary.Api.Controllers
{
    ...
    public class Tricks : ControllerBase
    {
        ...
        // /api/tricks/{id}
        [HttpGet("{id}")]
        public IActionResult Get(int id) => Ok(_store.All.FirstOrDefault(s => s.Id.Equals(id)));
        
        // /api/tricks/{id}/submissions - not implemented
        /*[HttpGet("{id}")]
        public IActionResult GetSub(int id) => Ok(_store.All.FirstOrDefault(s => s.Id.Equals(id)));*/
